...
<div>
    ...
    <br>
    <br>
    Je hebt recentelijk een reactie geplaatst op een post op www.weezenhofburenhulp.nl. 
    <br>
    <br>
    <h3>Versturen</h3>
    Om deze reactie te versturen, <a href=<a href={{ URL::to("/verificatie/r/") }}/{!! $hash !!}>klik hier</a>.
    <br>
